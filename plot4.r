household_household_power - read.table("d://data/household_household_power_consumption _consumption.txt", sep = ";", h=T)
...
household_power_consumption  <- cbind(datetime, household_power_consumption [,-(1:2)])
...
ing_3 ~ household_power_consumption $datetime, col = "Blue")
